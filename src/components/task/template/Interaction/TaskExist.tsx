      ...
      <div className=' w-full flex gap-6 items-center justify-between  flex-grow p-5'>
        ...
        <div className='flex flex-col items-center gap-2 relative flex-grow'>
          ...
          <div className=' w-full'>
            <Input placeholder='Input Contract address'  className=' w-full placeholder:text-center h-14 text-center'/>
            <Input placeholder='Input tx count'  className=' w-full placeholder:text-center h-14 text-center'/>
          </div>
        </div>
      </div>
    </div>
